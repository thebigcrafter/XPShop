...
class Main extends PluginBase
{
    ...
    public function onEnable()
    {
        ...
        UpdateNotifier::checkUpdate("XPShop", "1.0.5");
    }
    ...
    public function buyForm($player)
    {
        ...
        $form->addSlider($this->cfg->get("buy_slider_label"), 1, floor(EconomyAPI::getInstance()->myMoney($player) / $this->cfg->get("xpPriceWhenBuy")) - 1);
        $player->sendForm($form);
        return true;
    }
}
